...
seconds_in_lifespan <- seconds_in_year * 79
print(seconds_in_lifespan)
### Age of the universe is 13.8 billion years.  What is it's age in seconds?
seconds_in_uni <- seconds_in_year * 13800000000
...
makeIntroduction <- function(name, age){
  short_intro <- paste("Hello, my name is", name, " and I'm", age, "years old")
  return(short_intro)
}
...
movies <- c("Cloudy with a Chance of Meatballs", "Dark Knight Rises", "Kingsman", "Superbad", "This is the End", "Ted")

# Create a vector `top_three` that only contains the first three movies in the vector
top_three <- c("Cloudy with a Chance of Meatballs", "Dark Knight Rises", "Kingsman")
...
without_four <- c("Cloudy with a Chance of Meatballs", "Dark Knight Rises", "Kingsman", "This is the End", "Ted")
